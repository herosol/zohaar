        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label class="control-label" for="site_second_section_heading">First Section Heading<span class="symbol required">*</span></label>
                            <input type="text" name="site_second_section_heading" value="<?php if (isset($adminsite_setting->site_second_section_heading)) echo $adminsite_setting->site_first_section_heading; ?>"  class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
