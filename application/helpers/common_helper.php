...
function team_type($status)
{
    if ($status == '1') {
        return '<strong style="color:green;">Leadership Team</strong>';
    } else {
        return '<strong style="color:blue;">Advisor</strong>';
    }
}
...
function num_size($num,$size=6){
    return sprintf('CRYINC'.'%0'.$size.'d',$num);
